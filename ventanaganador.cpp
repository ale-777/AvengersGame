    ...
    ui(new Ui::ventanaGanador)
{
    ...
    int totalAniquiladores = listaCorvus.largo+listaMidnight.largo+listaNebula.largo+listaBlack.largo+listaThanos.largo;
    ui->lbl_totalAniquiladores->setText(QString::number(totalAniquiladores));

    //ui->lbl_antman->setText(QString::number(listaA.largo));
    ...
    int totalAvengers = listaIronMan.largo+listaThor.largo+listaSpiderman.largo;
